    ...
    <div>
      ...
      <div className="page-body">
        ...
        <div className="card" style={{marginBottom:0}}>
          ...
          {[
            { q:'Does it work without internet?', a:'The app itself loads from your phone, but live scores and the leaderboard need a connection.' },
            { q:'Do I need to update it?', a:'Nope - it updates on its own next time you open it.' },
            { q:'Does it take up space on my phone?', a:'Almost none. All your data is stored online, not on your device.' },
            { q:'Can I get notifications?', a:'Android yes. iPhone support is still limited by Apple.' },
          ].map((f,i,arr) => (
