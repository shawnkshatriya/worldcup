export const THEMES = {
  dark: {
    ...
    vars: {
      ...
      '--c-bracket-line': 'rgba(255,255,255,0.32)',
      '--c-text':     '#EEF0F8',
      '--c-muted':    '#6B7494',
      '--c-hint':     '#3F4664',
      '--c-accent':   '#C8102E',
      '--c-accent2':  '#F0A500',
      '--c-banner-bg': 'linear-gradient(135deg,#C8102E 0%,#A00D24 100%)',
  ...
  light: {
    ...
    vars: {
      ...
      '--c-bracket-line': 'rgba(0,0,0,0.30)',
      '--c-text':     '#1A1F2E',
      '--c-muted':    '#5A6380',
      '--c-hint':     '#8A94B0',
      '--c-accent':   '#B50D26',
      '--c-accent2':  '#C07800',
      '--c-banner-bg': 'linear-gradient(135deg,#B50D26 0%,#8E0A1E 100%)',
      '--c-banner-text': '#ffffff',
      '--c-success':  '#167A3A',
      '--c-warn':     '#B45309',
      '--c-danger':   '#C41E1E',
  ...
  worldcup: {
    ...
    vars: {
      ...
      '--c-bracket-line': 'rgba(0,80,0,0.55)',
      '--c-text':     '#F0FFF2',
      '--c-muted':    '#A8D4AC',
      '--c-hint':     '#6FA875',
      '--c-accent':   '#FFD700',
      '--c-accent2':  '#FFA500',
      '--c-banner-bg': 'linear-gradient(135deg,#0A5C2E 0%,#063D1E 100%)',
      '--c-banner-text': '#FFD700',
      '--c-success':  '#90EE90',
      '--c-warn':     '#FFD700',
      '--c-danger':   '#FF6B6B',
      '--c-info':     '#1D4ED8',
